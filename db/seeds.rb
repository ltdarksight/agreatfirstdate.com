...
WHERE_DID_YOU_GO = TRAVEL.event_types.create!(name: 'where_did_you_go', has_attachments: true, title: "#[where_did_you_go]", description: "#[thoughts]")
...
TOP_TRAVEL_SPOTS = TRAVEL.event_types.create!(name: 'top_travel_spots', has_attachments: false, title: "", description: "#[list_them]")
TOP_TRAVEL_SPOTS.event_descriptors.create!(field_type: :text, name: 'list_them')

PRIVATE_JET = TRAVEL.event_types.create!(name: 'private_jet', has_attachments: false, title: "", description: "#[i_would_be_off_to]")
PRIVATE_JET.event_descriptors.create!(field_type: :text, name: 'i_would_be_off_to')

DREAM_VACATION = TRAVEL.event_types.create!(name: 'dream_vacation', has_attachments: false, title: "", description: "#[text]")
DREAM_VACATION.event_descriptors.create!(field_type: :text, name: "text")

FAITH = PillarCategory.find(2)
I_WENT_TO_CHURCH = FAITH.event_types.create!(name: 'i_went_to_church', has_attachments: true, title: "", description: "#[thoughts]")
...
I_MEDITATED = FAITH.event_types.create!(name: 'i_meditated', has_attachments: true, title: "", description: "#[thoughts]")
...
DESCRIBE_FAITH = FAITH.event_types.create!(name: 'describe_faith', has_attachments: false, title: "", description: "#[text]")
DESCRIBE_FAITH.event_descriptors.create!(field_type: :text, name: "text")

FAITH_OTHER = FAITH.event_types.create!(name: 'faith_other', has_attachments: true, title: "", description: "#[describe_it]")
...
I_WORKED_OUT = HEALTH.event_types.create!(name: 'i_worked_out', has_attachments: true, title: "", description: "#[what_did_you_do]")
...
I_TOOK_UP_NEW = HEALTH.event_types.create!(name: 'i_took_up_new', has_attachments: true, title: "", description: "#[what_is_it]")
...
I_PLAYED = HEALTH.event_types.create!(name: 'i_played', has_attachments: true, title: "", description: "#[what_was_it]")
...
HEALTH_OTHER = HEALTH.event_types.create!(name: 'health_other', has_attachments: true, title: "", description: "#[describe_it]")
...
FAVORITE_TEAM = SPORT.event_types.create!(name: 'favorite_team', has_attachments: false, title: "", description: "#[who] ![is_my_favorite_team_for] #[how_long]")
...
I_WENT_TO_A_GAME = SPORT.event_types.create!(name: 'i_went_to_a_game', has_attachments: true, title: "", description: "![i_went_to_a_game_description] ")
...
I_WATCHED_TO_A_GAME = SPORT.event_types.create!(name: 'i_watched_to_a_game', has_attachments: false, title: "", description: "")
...
WARDROBE_UPGRADE = FASHION.event_types.create!(name: 'wardrobe_upgrade', has_attachments: true, title: "", description: "")
...
WENT_TO_A_SHOW = FASHION.event_types.create!(name: 'went_to_a_show', has_attachments: true, title: "", description: "")
...
I_LOOK_BEST_IN = FASHION.event_types.create!(name: 'i_look_best_in', has_attachments: true, title: "", description: "")
I_LOOK_BEST_IN.event_descriptors.create!(field_type: :text, name: "text")

FASHION_OTHER = FASHION.event_types.create!(name: 'fashion_other', has_attachments: true, title: "", description: "")
...
I_WENT_OUT = EAT_DRINK.event_types.create!(name: 'i_went_out', has_attachments: true, title: "", description: "")
...
I_COOKED = EAT_DRINK.event_types.create!(name: 'i_cooked', has_attachments: true, title: "", description: "")
...
TOP_RESTAURANTS = EAT_DRINK.event_types.create!(name: 'top_restaurants', has_attachments: false, title: "", description: "")
TOP_RESTAURANTS.event_descriptors.create!(field_type: :text, name: 'list_them')

MY_FAVORITE_FOOD = EAT_DRINK.event_types.create!(name: 'my_favorite_food', has_attachments: false, title: "", description: "")
MY_FAVORITE_FOOD.event_descriptors.create!(field_type: :text, name: "text")

MY_FAVORITE_DRINKS = EAT_DRINK.event_types.create!(name: 'my_favorite_drinks', has_attachments: false, title: "", description: "")
MY_FAVORITE_DRINKS.event_descriptors.create!(field_type: :text, name: "text")

EAT_DRINK_OTHER = EAT_DRINK.event_types.create!(name: 'eat_other', has_attachments: true, title: "", description: "")
...
READING = ART.event_types.create!(name: 'reading', has_attachments: false, title: "", description: "")
READING.event_descriptors.create!(field_type: :text, name: "text")
READING.event_descriptors.create!(field_type: :text, name: 'thoughts')

I_WROTE = ART.event_types.create!(name: 'i_wrote', has_attachments: false, title: "", description: "")
...
TOP_BOOKS = ART.event_types.create!(name: 'top_books', has_attachments: false, title: "", description: "")
TOP_BOOKS.event_descriptors.create!(field_type: :text, name: 'list_them')

I_CREATED = ART.event_types.create!(name: 'i_created', has_attachments: true, title: "", description: "")
...
TOP_ARTISTS = ART.event_types.create!(name: 'top_artists', has_attachments: false, title: "", description: "")
TOP_ARTISTS.event_descriptors.create!(field_type: :text, name: 'list_them')

I_WENT_TO_A_MUSEUM = ART.event_types.create!(name: 'i_went_to_a_museum', has_attachments: true, title: "", description: "")
I_WENT_TO_A_MUSEUM.event_descriptors.create!(field_type: :string, name: 'where')  #added
...
I_WENT_OUT_DANCING = MUSIC.event_types.create!(name: 'i_went_out_dancing', has_attachments: true, title: "", description: "")
...
LISTENING_TO = MUSIC.event_types.create!(name: 'listening_To', has_attachments: false, title: "", description: "")
...
I_WENT_TO_A_CONCERT = MUSIC.event_types.create!(name: 'i_went_to_a_concert', has_attachments: true, title: "", description: "")
...
TOP_MUSIC_ARTISTS = MUSIC.event_types.create!(name: 'top_music_artists', has_attachments: false, title: "", description: "")
TOP_MUSIC_ARTISTS.event_descriptors.create!(field_type: :text, name: 'list_them')

MUSIC_OTHER = MUSIC.event_types.create!(name: 'music_other', has_attachments: true, title: "", description: "")
...
I_WENT_OUT_MUSIC = MUSIC.event_types.create!(name: 'i_went_out_music', has_attachments: true, title: "", description: "")
I_WENT_OUT_MUSIC.event_descriptors.create!(field_type: :date, name: 'what_was_it') #added
...
TOP_SPOTS = MUSIC.event_types.create!(name: 'top_spots', has_attachments: false, title: "", description: "")
TOP_SPOTS.event_descriptors.create!(field_type: :text, name: 'list_them')

MOVIES = PillarCategory.find(10)
I_WATCHED_SOMETHING = MOVIES.event_types.create!(name: 'i_watched_something', has_attachments: false, title: "", description: "")
...
TOP_TV = MOVIES.event_types.create!(name: 'top_tv', has_attachments: false, title: "", description: "")
TOP_TV.event_descriptors.create!(field_type: :text, name: 'list_them')

TOP_MOVIES = MOVIES.event_types.create!(name: 'top_movies', has_attachments: false, title: "", description: "")
TOP_MOVIES.event_descriptors.create!(field_type: :text, name: 'list_them')

I_WENT_TO_MOVIES = MOVIES.event_types.create!(name: 'i_went_to_movies', has_attachments: true, title: "", description: "")
...
MY_FAMILY = FAMILY.event_types.create!(name: 'my_family', has_attachments: false, title: "", description: "")
MY_FAMILY.event_descriptors.create!(field_type: :text, name: "text")

KICKED_IT_WITH_THE_FAM = FAMILY.event_types.create!(name: 'kicked_it_with_the_fam', has_attachments: true, title: "", description: "")
...
PETS_ARE_FAMILY_TOO = FAMILY.event_types.create!(name: 'pets_are_family_too', has_attachments: true, title: "", description: "")
...
FAMILY_OTHER = FAMILY.event_types.create!(name: 'family_other', has_attachments: true, title: "", description: "")
...
I_VOLUNTEERED = CHARITY.event_types.create!(name: 'i_volunteered', has_attachments: true, title: "", description: "")
...
MY_CAUSES = CHARITY.event_types.create!(name: 'my_causes', has_attachments: false, title: "", description: "")
MY_CAUSES.event_descriptors.create!(field_type: :text, name: 'list_them')

I_GAVE_TO_CHARITY = CHARITY.event_types.create!(name: 'i_gave_to_charity', has_attachments: false, title: "", description: "")
...
I_STUDIED_AT = EDUCATION.event_types.create!(name: 'i_studied_at', has_attachments: true, title: "", description: "")
...
I_WENT_TO_CLASS = EDUCATION.event_types.create!(name: 'i_went_to_class', has_attachments: true, title: "", description: "")
...
WORKING_HARD = EDUCATION.event_types.create!(name: 'working_hard', has_attachments: false, title: "", description: "")
...
WHAT_I_DO = EDUCATION.event_types.create!(name: 'what_i_do', has_attachments: false, title: "", description: "")
