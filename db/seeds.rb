...
man = FactoryGirl.create :user, email: 'man@rubybackers.com'
man.build_profile({
  who_am_i: 'I am a man',
  who_meet: 'woman',
  first_name: 'John',
...
20.times do
  f = FactoryGirl.create :male, pillar_category_ids: category_ids,
...
70.times do
  f = FactoryGirl.create :female, pillar_category_ids: category_ids,
                 first_name: Faker::Name.first_name,
                 last_name: Faker::Name.last_name,
                 who_am_i: Faker::Lorem.paragraph(5),
                 who_meet: Faker::Lorem.paragraph(5),
